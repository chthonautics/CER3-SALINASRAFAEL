...
class eventform(forms.Form):
    name            = forms.CharField(max_length=256, widget=forms.TextInput(attrs={'class': "form-control"}))
    description     = forms.CharField(max_length=2048, widget=forms.Textarea(attrs={'class': "form-control"}))
    date_start      = forms.CharField(max_length=16, widget=forms.TextInput(attrs={'class': "form-control", 'oninput': "verify()"}))
    date_end        = forms.CharField(max_length=16, widget=forms.TextInput(attrs={'class': "form-control", 'oninput': "verify()"}))
